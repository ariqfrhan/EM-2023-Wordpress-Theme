        ...
        <div class="row">
            <div class="col-md-6 col-12 my-auto" data-aos="fade-right" data-aos-duration="1000">
                <div class="col-md-3 mb-3 d-sm-block d-none">
                    <img src="<?php echo get_theme_file_uri("/assets/images/kementrian/bumm/logo.png") ?>" alt="sekkab logo" class="img-fluid">
                </div>
                <div class="col-md-12 title-menteri text-sm-start text-center">
                    <h2 class="fw-bold">KEMENTERIAN BADAN USAHA MILIK MAHASISWA</h2>
                    <h2 class="fw-bold bawah">EM UB 2023</h2>
                </div>
            </div>
            <div class="col-md-6 col-12">
                <div class="col-12" data-aos="fade-up" data-aos-duration="1000">
                    <img src="<?php echo get_theme_file_uri("/assets/images/kementrian/bumm/bph.png") ?>" class="img-fluid" id="img-menteri">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row row-cols-md-2 row-cols-1">
            ...
            $leftAccordionData = array(
                array(
                    "heading" => "Becreave Catalog",
                    "content" => "Becreav Catalog berfokus pada penjualan barang dagangan seperti merch,
                    konveksi, dan vendor percetakan serta kebutuhan mahasiswa."
                ),
                array(
                    "heading" => "Belly.com",
                    "content" => "Belly.com berfokus pada bisnis makanan dan minuman di lingkungan
            ...
            $rightAccordionData = array(
                array(
                    "heading" => "Brawloka",
                    "content" => "Brawloka berfokus pada penyelenggara acara visitasi Universitas Brawijaya dan
                    layanan tour guide."
                ),
                array(
                    "heading" => "Harmoney Project",
                    "content" => "Harmoney Project berfokus pada kemitraan dan pelayanan terpadu, sehingga
                    target dapat dijangkau secara luas."
                ),
            );
            //leftAccordion
